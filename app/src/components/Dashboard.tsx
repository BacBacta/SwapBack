...
export const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Global Stats */}
      <div className="backdrop-blur-xl bg-[#10B981]/5 border-2 border-[#10B981]/30 rounded-2xl p-6 shadow-[0_0_30px_rgba(0,255,0,0.2)] transition-all hover:border-[#10B981]/50">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 backdrop-blur-lg bg-[#10B981]/10 hover:bg-[#10B981]/20 rounded-lg border border-[#10B981]/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_15px_rgba(0,255,0,0.2)]"
            ...
            {/* Indicateur Live */}
            <div className="flex items-center gap-2 px-3 py-1.5 backdrop-blur-lg bg-[#06B6D4]/10 rounded-lg border border-[#06B6D4]/40 shadow-[0_0_15px_rgba(0,255,255,0.2)]">
              <span
      ...
      {/* Tabs Navigation */}
      <div className="flex gap-2 p-2 backdrop-blur-xl bg-[#10B981]/5 rounded-2xl border-2 border-[#10B981]/30 shadow-[0_0_20px_rgba(0,255,0,0.15)]">
        <button
      ...
      {activeTab === "lock-unlock" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="backdrop-blur-xl bg-[#10B981]/5 border-2 border-[#10B981]/30 rounded-2xl p-6 shadow-[0_0_30px_rgba(0,255,0,0.2)] hover:border-[#10B981]/50 transition-all">
      ...
      {activeTab === "overview" && userStats && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="backdrop-blur-xl bg-[#10B981]/5 border-2 border-[#10B981]/30 rounded-2xl p-5 hover:border-[#10B981]/60 hover:shadow-[0_0_25px_rgba(0,255,0,0.3)] transition-all">
            ...
            <div className="backdrop-blur-xl bg-[#06B6D4]/5 border-2 border-[#06B6D4]/30 rounded-2xl p-5 hover:border-[#06B6D4]/60 hover:shadow-[0_0_25px_rgba(0,255,255,0.3)] transition-all">
              <div className="flex items-center gap-3 mb-3">
          ...
          {cnftData && cnftData.exists && cnftData.isActive && (
            <div className="backdrop-blur-xl bg-[#10B981]/5 border-2 border-[#10B981]/30 rounded-2xl p-5 shadow-[0_0_25px_rgba(0,255,0,0.2)]">
          ...
          {hasBalance && pendingNpi > 0 && (
            <div className="backdrop-blur-xl bg-[#10B981]/10 border-2 border-[#10B981]/50 rounded-2xl p-6 hover:border-[#10B981] hover:shadow-[0_0_40px_rgba(0,255,0,0.4)] hover:scale-[1.01] transition-all">
