      ...
      >
        <div className="swap-card animate-scale-in">
          ...
          <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/10">
            ...
            <button
              onClick={() => setIsOpen(false)}
              className="w-8 h-8 rounded-lg hover:bg-white/10 transition-colors flex items-center justify-center text-gray-400 hover:text-white focus-visible-ring"
            ...
            <div className="grid gap-3">
              {shortcuts.map((shortcut) => (
                ...
                >
                  ...
                  <kbd className="px-3 py-1.5 rounded-lg bg-black/50 border border-white/10 font-mono text-sm text-[var(--primary)] font-semibold">
                    {shortcut.keys}
                  </kbd>
                </div>
              ))}
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            <p className="text-sm text-gray-500">
              Press <kbd className="px-2 py-1 rounded bg-black/30 border border-white/10 font-mono text-xs">Esc</kbd> to close
            </p>
          </div>
        </div>
      </div>
