...
export default function PreviewLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#0C0C0C] text-[#00FF00] font-mono">
      {/* Header de sélection */}
      <div className="sticky top-0 z-50 bg-[#0C0C0C] border-b-2 border-[#00FF00]/30 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <h1 className="text-xl font-bold">
            <span className="text-[#00FF00]">&gt;</span> PREVIEW LANDING PAGES
          </h1>
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 border-2 transition-all ${
                activeDesign === 1
                  ? 'bg-[#00FF00] text-[#0C0C0C] border-[#00FF00]'
                  : 'bg-transparent text-[#00FF00] border-[#00FF00]/30 hover:border-[#00FF00]'
              }`}
            >
              DESIGN 1
            </button>
      ...
      {/* Footer de sélection */}
      <div className="fixed bottom-0 left-0 right-0 bg-[#0C0C0C] border-t-2 border-[#00FF00]/30 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="text-sm">
            <span className="text-[#00FF00]/70">Actuellement:</span>{' '}
            <span className="text-[#00FF00] font-bold">DESIGN {activeDesign}</span>
          </div>
          <Link
            href="/dashboard"
            className="px-6 py-2 bg-[#00FF00] text-[#0C0C0C] font-bold border-2 border-[#00FF00] hover:bg-transparent hover:text-[#00FF00] transition-all"
          >
            RETOUR AU DASHBOARD
          </Link>
        </div>
...
function Design1() {
  return (
    <div className="max-w-7xl 3xl:max-w-10xl 4xl:max-w-11xl mx-auto space-y-12 pb-24">
      {/* Hero Section */}
      <section className="border-2 border-[#00FF00] p-8 bg-[#00FF00]/5 relative overflow-hidden">
        {/* Scan line effect */}
        ...
        <div className="relative space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-sm animate-pulse">
              <span className="text-[#00FF00]">&gt;</span> INITIALIZING SWAPBACK PROTOCOL...
            </p>
            <p className="text-sm">
              <span className="text-[#00FF00]">&gt;</span> LOADING MODULES... [████████████] 100%
            </p>
          </div>

          {/* ASCII Art Logo */}
          <pre className="text-[#00FF00] text-xs sm:text-sm leading-tight overflow-x-auto">
{`
   ███████╗██╗    ██╗ █████╗ ██████╗ 
   ██╔════╝██║    ██║██╔══██╗██╔══██╗
   ███████╗██║ █╗ ██║███████║██████╔╝
...
`}
          ...
          <div className="space-y-2 text-center">
            <p className="text-xl font-bold uppercase tracking-wider">
              <span className="text-[#00FF00]">&gt;</span> DECENTRALIZED SWAP PROTOCOL
            </p>
            <p className="text-sm text-[#00FF00]/70 uppercase">
              <span className="text-[#00FF00]">&gt;</span> POWERED BY SOLANA BLOCKCHAIN
            </p>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button className="px-8 py-3 bg-[#00FF00] text-[#0C0C0C] font-bold border-2 border-[#00FF00] hover:bg-transparent hover:text-[#00FF00] transition-all uppercase">
              [CONNECT_WALLET]
            </button>
            <button className="px-8 py-3 bg-transparent text-[#00FF00] font-bold border-2 border-[#00FF00] hover:bg-[#00FF00] hover:text-[#0C0C0C] transition-all uppercase">
              [VIEW_DOCS]
            </button>
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div key={i} className="border-2 border-[#00FF00] p-6 bg-[#00FF00]/5 hover:bg-[#00FF00]/10 transition-all">
            <div className="space-y-4">
              <h3 className="text-xl font-bold">
                <span className="text-[#00FF00]">&gt;</span> {feature.title}
              </h3>
              <ul className="space-y-2 text-sm">
                {feature.items.map((item, j) => (
                  <li key={j} className="flex items-center gap-2">
                    <span className="text-[#00FF00]">█</span>
                    <span className="text-[#00FF00]/70">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="border-2 border-[#00FF00] p-6 bg-[#00FF00]/5">
        <div className="space-y-4">
          <h3 className="text-xl font-bold">
            <span className="text-[#00FF00]">&gt;</span> SYSTEM_STATUS
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              <p className="text-[#00FF00]/70">STATUS:</p>
              <p className="font-bold text-[#00FF00]">OPERATIONAL</p>
            </div>
            <div>
              <p className="text-[#00FF00]/70">TOTAL_VOLUME:</p>
              <p className="font-bold text-[#00FF00]">$X.XXM</p>
            </div>
            <div>
              <p className="text-[#00FF00]/70">TOTAL_SWAPS:</p>
              <p className="font-bold text-[#00FF00]">X,XXX</p>
            </div>
            <div>
              <p className="text-[#00FF00]/70">BACK_BURNED:</p>
              <p className="font-bold text-[#00FF00]">X,XXX</p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="max-w-7xl 3xl:max-w-10xl 4xl:max-w-11xl mx-auto space-y-12 pb-24">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative border-4 border-[#00FF00] p-12 text-center space-y-8 bg-[#0C0C0C]/90">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 opacity-70 glitch-layer-2">
              <h1 className="text-6xl md:text-8xl font-bold tracking-wider">
                <span className="text-[#00FFFF]">SWAP</span>
                <span className="text-[#00FF00]">BACK</span>
              </h1>
            </div>
          </div>
          ...
          <div className="flex justify-center">
            <div className="h-2 w-64 bg-[#00FF00]/20 overflow-hidden">
              <div className="h-full w-1/2 bg-[#00FF00] animate-glitch-scan" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-3xl font-bold uppercase tracking-widest text-[#00FF00]">
              DECENTRALIZED TRADING
            </p>
          </div>

          {/* CTA */}
          <button className="mt-8 px-12 py-4 bg-[#00FF00] text-[#0C0C0C] text-xl font-bold border-4 border-[#00FF00] hover:bg-transparent hover:text-[#00FF00] transition-all shadow-[0_0_30px_rgba(0,255,0,0.5)] hover:shadow-[0_0_50px_rgba(0,255,0,0.8)] uppercase">
            █ LAUNCH APP █
          </button>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div
            key={i}
            className="border-4 border-[#00FF00] p-8 bg-[#0C0C0C] hover:bg-[#00FF00]/10 transition-all relative overflow-hidden group"
            style={{
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={i} className="space-y-2">
              ...
              <p className="text-3xl font-bold text-[#00FF00]" style={{
...
function Design3() {
  return (
    <div className="max-w-7xl 3xl:max-w-10xl 4xl:max-w-11xl mx-auto space-y-12 pb-24">
      {/* Terminal Header */}
      <section className="border-2 border-[#00FF00] bg-[#0C0C0C] p-8 font-mono">
        <div className="space-y-4">
          {/* Terminal prompt */}
          ...
          <div className="border-2 border-[#00FF00]/50 p-6 space-y-4">
            <div className="flex items-center gap-2">
              <span className="text-[#00FF00]">{'━'.repeat(50)}</span>
            </div>
            <div className="text-center space-y-2">
              <h1 className="text-4xl font-bold text-[#00FF00]">
                SWAPBACK PROTOCOL v2.0
              </h1>
              <p className="text-lg text-[#00FF00]/70 uppercase">
          ...
          <div className="pt-4 space-y-2">
            ...
            <p className="text-sm pl-4">
              <span className="text-[#00FF00]">&gt;</span> Connecting to Solana...
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="px-6 py-2 bg-[#00FF00] text-[#0C0C0C] font-bold border-2 border-[#00FF00] hover:bg-transparent hover:text-[#00FF00] transition-all">
              [CONNECT]
            </button>
            <button className="px-6 py-2 bg-transparent text-[#00FF00] font-bold border-2 border-[#00FF00] hover:bg-[#00FF00] hover:text-[#0C0C0C] transition-all">
              [DOCUMENTATION]
            </button>
          </div>
        </div>
          ...
          <div className="border-2 border-[#00FF00] p-4 bg-[#00FF00]/5">
            <div className="space-y-2 text-sm">
              ...
              <p className="pl-2">
                ...
                <span className="text-[#00FF00]/30">{'░'.repeat(3)}</span> XXX
              </p>
              <p className="pl-2">
                │ DCA: <span className="text-[#00FF00]">{'█'.repeat(8)}</span>
                <span className="text-[#00FF00]/30">{'░'.repeat(7)}</span> XX
              </p>
              <p className="pl-2">
                │ Buyback: <span className="text-[#00FF00]">{'█'.repeat(4)}</span>
                <span className="text-[#00FF00]/30">{'░'.repeat(11)}</span> X
              </p>
              <p>
                └{'─'.repeat(32)}┘
              </p>
      ...
      <section className="border-2 border-[#00FF00] p-4 bg-[#00FF00]/5">
        <div className="space-y-2 text-sm">
          ...
          <div className="pl-4 flex gap-4">
            <span className="text-[#00FF00] hover:text-[#00FFFF] cursor-pointer">[GitHub]</span>
            <span className="text-[#00FF00] hover:text-[#00FFFF] cursor-pointer">[Twitter]</span>
            <span className="text-[#00FF00] hover:text-[#00FFFF] cursor-pointer">[Discord]</span>
            <span className="text-[#00FF00] hover:text-[#00FFFF] cursor-pointer">[Docs]</span>
          </div>
        </div>
      </section>
    </div>
