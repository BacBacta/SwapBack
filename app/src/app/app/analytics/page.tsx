    ...
    <div className="max-w-4xl mx-auto px-3 sm:px-4 space-y-4 sm:space-y-8">
      ...
      >
        <div className="inline-flex items-center gap-2 mb-2 sm:mb-3">
          ...
          <h1 className="text-xl sm:text-3xl font-bold text-white/90">
            Analytics
          </h1>
        </div>
      ...
      >
        {stats.map((stat, index) => (
          <motion.div
            ...
            className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 hover:border-emerald-500/30 transition-all"
          >
            <div className="text-xs text-gray-500 mb-1">{stat.label}</div>
            <div className="text-lg sm:text-xl font-bold text-white/90 mb-1">{stat.value}</div>
      ...
      >
        <h3 className="text-xs sm:text-sm font-semibold text-white/90 mb-3 sm:mb-4">Volume (7 days)</h3>
        ...
        <div className="flex justify-between mt-2">
          {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map((day) => (
            <div key={day} className="text-[10px] sm:text-xs text-gray-500">{day}</div>
          ))}
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="bg-white/5 border border-white/10 rounded-xl p-4 sm:p-6"
      >
        <h3 className="text-xs sm:text-sm font-semibold text-white/90 mb-3 sm:mb-4">Trades (7 days)</h3>
        <div className="h-32 sm:h-48 flex items-end gap-1 sm:gap-2">
