...
pub fn handler(
    ...
    require!(args.interval_seconds >= 3600, SwapbackError::IntervalTooShort); // Min 1 hour
    require!(args.interval_seconds <= 31536000, SwapbackError::IntervalTooLong); // Max 1 year
