...
mod tests {
    ...
    fn test_excellent_venue_score() {
        ...
        assert!(venue.quality_score > 5000, "Excellent venue should have high score");
    }
    ...
    fn test_poor_venue_score() {
        ...
        assert!(venue.quality_score < 3500, "Poor venue should have low score, got {}", venue.quality_score);
    }
