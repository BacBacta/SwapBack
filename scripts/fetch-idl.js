...
const programs = [
  ...
  { name: 'swapback_router', id: 'GTNyqcgqKHRu3o636WkrZfF6EjJu1KP62Bqdo52t3cgt' },
  { name: 'swapback_buyback', id: 'EoVjmALZdkU3N9uehxVV4n9C6ukRa8QrbZRMHKBD2KUf' },
];
...
async function main() {
  ...
  const keypair = anchor.web3.Keypair.fromSecretKey(Uint8Array.from(JSON.parse(secretKey)));
