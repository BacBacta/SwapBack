...
async function checkPrograms() {
  try {
    ...
    const commonSwapId = new PublicKey('FATq512CLwLAcxcJGRQosgxMTHnxRwvhPHKZGUBY1wxg');
    const routerId = new PublicKey('3d7RVuiAvEYCrQp8534nJ1TnyAYUoqrnBPEGXvaMhYwa');
    const cnftId = new PublicKey('2HAiig6cGhtB9RZow4hXDPEPamUBS3EdZfnjAyDpC7BU');
